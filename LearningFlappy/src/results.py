...
interesting2 = np.array([73, 14, 11, 7, 90, 123, 68, 171, 41, 96, 31, 21, 18, 208, 129, 57, 37, 45, 44, 31, 28, 32, 25, 23, 23, 67,
    68, 35, 149, 92, 190, 46, 211, 163, 121, 11, 125, 148, 26, 100, 42, 18, 57, 95, 154, 41, 27, 138, 48, 44])
print(np.mean(interesting2))
